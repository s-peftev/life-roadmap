...
namespace LR.Application.Interfaces.Utils
{
    public interface IAccountService
    {
        ...
        Task<Result> LogoutAsync(string userId, CancellationToken ct = default);
        ...
        Task<Result> ChangeUsernameAsync(ChangeUsernameRequest changeUsernameRequest, string userId);
        Task<Result> ChangePasswordAsync(ChangePasswordRequest changePasswordRequest, string userId);
    }
}